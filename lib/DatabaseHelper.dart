...
class DatabaseHelper {
  ...
  static final columnBankName = 'bankName';
  static final columnBankAccNum = 'bankAccNum';
  static final columnMoney = 'money_amount';
  ...
  //The number of affected rows is returned. This should be 1 as long as the row exists
